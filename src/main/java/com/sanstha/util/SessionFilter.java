...
public class SessionFilter implements Filter
{
			...
			FilterChain chain) throws IOException, ServletException
	{
		...
		if ("".equals(requestedPage) || requestedPage.contains("footer") || "registration".equals(requestedPage) || requestedPage.contains("loginAuth") || requestedPage.contains("resources") || requestedPage.contains(".htm"))
		{
