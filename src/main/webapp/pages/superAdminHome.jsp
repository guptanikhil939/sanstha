		...
		<div class="container">
			<div class="col-md-8">
				<div class="media-body"
					...
					<h3 class="media-heading">Super Admin</h3>
					<div>&nbsp;</div>
					<p>
						<c:if test="${userDTO.about.length() != 0 }">
							<span id="displayAbout"><c:out value="${userDTO.emailId}" /></span>
						</c:if>
					</p>
				</div>
				<div class="row">&nbsp;</div>
			...
			<div class="col-md-4">
				<div class="media-body"
					style="border: 2px solid #eaeaea; border-radius: 10px; padding: 4px;">
					<h3 class="media-heading">Recently Added Societies</h3>
					<div>
				...
				<div class="media-body"
					style="border: 2px solid #eaeaea; border-radius: 10px; padding: 4px;">
					<h3 class="media-heading">Recently Added Members</h3>
					<div>
						<form id="viewMember" method="post" action="viewProfile">
							<input type="hidden" id="memberId" name="memberId"
								class="form-control">
				...
				<div class="media-body"
					style="border: 2px solid #eaeaea; border-radius: 10px; padding: 4px;">
					<h3 class="media-heading">Recent Transactions</h3>
					<div class="row">&nbsp;</div>
					<p>No transactions.</p>
				</div>
				<div class="row">&nbsp;</div>
				<div class="media-body"
					style="border: 2px solid #eaeaea; border-radius: 10px; padding: 4px;">
					<h3 class="media-heading">Recent Events</h3>
					<div class="row">&nbsp;</div>
					<div>
